...
class OdiScreen extends StatefulWidget {
  const OdiScreen({super.key});

  @override
  State<OdiScreen> createState() => _OdiScreenState();
}

class _OdiScreenState extends State<OdiScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final odi = provider.getMoviesByCategoryId(39).reversed.toList();

    return Scaffold(
      backgroundColor: Colors.black,
      appBar: AppBar(
        title: const AppText("ODI Matches", fontSize: 25, color: Colors.white),
