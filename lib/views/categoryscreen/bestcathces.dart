...
class BestCatches extends StatefulWidget {
  const BestCatches({super.key});

  @override
  State<BestCatches> createState() => _BestCatchesState();
}

class _BestCatchesState extends State<BestCatches> {
  ...
  Widget build(BuildContext context) {
    ...
    final twenty = provider.getMoviesByCategoryId(43).reversed.toList();

    return Scaffold(
      backgroundColor: Colors.black,
      appBar: AppBar(
        title: const AppText("Best Catches", fontSize: 25, color: Colors.white),
