...
class WorldcupMatches extends StatefulWidget {
  const WorldcupMatches({super.key});

  @override
  State<WorldcupMatches> createState() => _WorldcupMatchesState();
}

class _WorldcupMatchesState extends State<WorldcupMatches> {
  ...
  Widget build(BuildContext context) {
    ...
    final twenty = provider.getMoviesByCategoryId(41).reversed.toList();
