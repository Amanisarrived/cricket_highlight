...
class FunnyMoments extends StatefulWidget {
  const FunnyMoments({super.key});

  @override
  State<FunnyMoments> createState() => _FunnyMomentsState();
}

class _FunnyMomentsState extends State<FunnyMoments> {
  ...
  Widget build(BuildContext context) {
    ...
    final twenty = provider.getMoviesByCategoryId(44).reversed.toList();
